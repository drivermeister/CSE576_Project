...
xnpb4_ = round(NPB4(1:end,1:2)'*scale);
ynpb4_ = round(NPB4(1:end,3:4)'*scale);
NPB3 = csvread('clust_NP_B003.csv');
xnpb3_ = round(NPB3(1:end,1:2)'*scale);
ynpb3_ = round(NPB3(1:end,3:4)'*scale);
NPB2 = csvread('clust_NP_B002.csv');
xnpb2_ = round(NPB2(1:end,1:2)'*scale);
ynpb2_ = round(NPB2(1:end,3:4)'*scale);
NPB1 = csvread('clust_NP_B001.csv');
xnpb1_ = round(NPB1(1:end,1:2)'*scale);
ynpb1_ = round(NPB1(1:end,3:4)'*scale);
...
xktc4_ = round(KTC4(1:end,1:2)'*scale);
yktc4_ = round(KTC4(1:end,3:4)'*scale);
KTC3 = csvread('clust_KT_C003.csv');
xktc3_ = round(KTC3(1:end,1:2)'*scale);
yktc3_ = round(KTC3(1:end,3:4)'*scale);
KTC2 = csvread('clust_KT_C002.csv');
xktc2_ = round(KTC2(1:end,1:2)'*scale);
yktc2_ = round(KTC2(1:end,3:4)'*scale);
KTC1 = csvread('clust_KT_C001.csv');
xktc1_ = round(KTC1(1:end,1:2)'*scale);
yktc1_ = round(KTC1(1:end,3:4)'*scale);

NPC5 = csvread('clust_NP_C005.csv');
xnpc5_ = round(NPC5(1:end,1:2)'*scale);
ynpc5_ = round(NPC5(1:end,3:4)'*scale);
NPC4 = csvread('clust_NP_C004.csv');
xnpc4_ = round(NPC4(1:end,1:2)'*scale);
ynpc4_ = round(NPC4(1:end,3:4)'*scale);
NPC3 = csvread('clust_NP_C003.csv');
xnpc3_ = round(NPC3(1:end,1:2)'*scale);
ynpc3_ = round(NPC3(1:end,3:4)'*scale);
NPC2 = csvread('clust_NP_C002.csv');
xnpc2_ = round(NPC2(1:end,1:2)'*scale);
ynpc2_ = round(NPC2(1:end,3:4)'*scale);
NPC1 = csvread('clust_NP_C001.csv');
xnpc1_ = round(NPC1(1:end,1:2)'*scale);
ynpc1_ = round(NPC1(1:end,3:4)'*scale);

SC5 = csvread('clust_S_C005.csv');
xsc5_ = round(SC5(1:end,1:2)'*scale);
ysc5_ = round(SC5(1:end,3:4)'*scale);
SC4 = csvread('clust_S_C004.csv');
xsc4_ = round(SC4(1:end,1:2)'*scale);
ysc4_ = round(SC4(1:end,3:4)'*scale);
SC3 = csvread('clust_S_C003.csv');
xsc3_ = round(SC3(1:end,1:2)'*scale);
ysc3_ = round(SC3(1:end,3:4)'*scale);
SC2 = csvread('clust_S_C002.csv');
xsc2_ = round(SC2(1:end,1:2)'*scale);
ysc2_ = round(SC2(1:end,3:4)'*scale);
SC1 = csvread('clust_S_C001.csv');
xsc1_ = round(SC1(1:end,1:2)'*scale);
ysc1_ = round(SC1(1:end,3:4)'*scale);
...
xnpd5_ = round(NPD5(1:end,1:2)'*scale);
ynpd5_ = round(NPD5(1:end,3:4)'*scale);
NPD4 = csvread('clust_NP_D004.csv');
xnpd4_ = round(NPD4(1:end,1:2)'*scale);
ynpd4_ = round(NPD4(1:end,3:4)'*scale);
NPD3 = csvread('clust_NP_D003.csv');
xnpd3_ = round(NPD3(1:end,1:2)'*scale);
ynpd3_ = round(NPD3(1:end,3:4)'*scale);
NPD2 = csvread('clust_NP_D002.csv');
xnpd2_ = round(NPD2(1:end,1:2)'*scale);
ynpd2_ = round(NPD2(1:end,3:4)'*scale);
NPD1 = csvread('clust_NP_D001.csv');
xnpd1_ = round(NPD1(1:end,1:2)'*scale);
ynpd1_ = round(NPD1(1:end,3:4)'*scale);
...
xkte5_ = round(KTE5(1:end,1:2)'*scale);
ykte5_ = round(KTE5(1:end,3:4)'*scale);
KTE4 = csvread('clust_KT_E004.csv');
xkte4_ = round(KTE4(1:end,1:2)'*scale);
ykte4_ = round(KTE4(1:end,3:4)'*scale);
KTE3 = csvread('clust_KT_E003.csv');
xkte3_ = round(KTE3(1:end,1:2)'*scale);
ykte3_ = round(KTE3(1:end,3:4)'*scale);
KTE2 = csvread('clust_KT_E002.csv');
xkte2_ = round(KTE2(1:end,1:2)'*scale);
ykte2_ = round(KTE2(1:end,3:4)'*scale);
KTE1 = csvread('clust_KT_E001.csv');
xkte1_ = round(KTE1(1:end,1:2)'*scale);
ykte1_ = round(KTE1(1:end,3:4)'*scale);

NPE5 = csvread('clust_NP_E005.csv');
xnpe5_ = round(NPE5(1:end,1:2)'*scale);
ynpe5_ = round(NPE5(1:end,3:4)'*scale);
NPE4 = csvread('clust_NP_E004.csv');
xnpe4_ = round(NPE4(1:end,1:2)'*scale);
ynpe4_ = round(NPE4(1:end,3:4)'*scale);
NPE3 = csvread('clust_NP_E003.csv');
xnpe3_ = round(NPE3(1:end,1:2)'*scale);
ynpe3_ = round(NPE3(1:end,3:4)'*scale);
% no 2
NPE1 = csvread('clust_NP_E001.csv');
xnpe1_ = round(NPE1(1:end,1:2)'*scale);
ynpe1_ = round(NPE1(1:end,3:4)'*scale);

SE5 = csvread('clust_S_E005.csv');
xse5_ = round(SE5(1:end,1:2)'*scale);
yse5_ = round(SE5(1:end,3:4)'*scale);
SE4 = csvread('clust_S_E004.csv');
xse4_ = round(SE4(1:end,1:2)'*scale);
yse4_ = round(SE4(1:end,3:4)'*scale);
SE3 = csvread('clust_S_E003.csv');
xse3_ = round(SE3(1:end,1:2)'*scale);
yse3_ = round(SE3(1:end,3:4)'*scale);
SE2 = csvread('clust_S_E002.csv');
xse2_ = round(SE2(1:end,1:2)'*scale);
yse2_ = round(SE2(1:end,3:4)'*scale);
SE1 = csvread('clust_S_E001.csv');
xse1_ = round(SE1(1:end,1:2)'*scale);
yse1_ = round(SE1(1:end,3:4)'*scale);

% F videos
KTF5 = csvread('clust_KT_F005.csv');
xktf5_ = round(KTF5(1:end,1:2)'*scale);
yktf5_ = round(KTF5(1:end,3:4)'*scale);
KTF4 = csvread('clust_KT_F004.csv');
xktf4_ = round(KTF4(1:end,1:2)'*scale);
yktf4_ = round(KTF4(1:end,3:4)'*scale);
KTF3 = csvread('clust_KT_F003.csv');
xktf3_ = round(KTF3(1:end,1:2)'*scale);
yktf3_ = round(KTF3(1:end,3:4)'*scale);
KTF2 = csvread('clust_KT_F002.csv');
xktf2_ = round(KTF2(1:end,1:2)'*scale);
yktf2_ = round(KTF2(1:end,3:4)'*scale);
KTF1 = csvread('clust_KT_F001.csv');
xktf1_ = round(KTF1(1:end,1:2)'*scale);
yktf1_ = round(KTF1(1:end,3:4)'*scale);

% no 5
NPF4 = csvread('clust_NP_F004.csv');
xnpf4_ = round(NPF4(1:end,1:2)'*scale);
ynpf4_ = round(NPF4(1:end,3:4)'*scale);
NPF3 = csvread('clust_NP_F003.csv');
xnpf3_ = round(NPF3(1:end,1:2)'*scale);
ynpf3_ = round(NPF3(1:end,3:4)'*scale);
% no 2
NPF1 = csvread('clust_NP_F001.csv');
xnpf1_ = round(NPF1(1:end,1:2)'*scale);
ynpf1_ = round(NPF1(1:end,3:4)'*scale);

SF5 = csvread('clust_S_F005.csv');
xsf5_ = round(SF5(1:end,1:2)'*scale);
ysf5_ = round(SF5(1:end,3:4)'*scale);
SF4 = csvread('clust_S_F004.csv');
xsf4_ = round(SF4(1:end,1:2)'*scale);
ysf4_ = round(SF4(1:end,3:4)'*scale);
SF3 = csvread('clust_S_F003.csv');
xsf3_ = round(SF3(1:end,1:2)'*scale);
ysf3_ = round(SF3(1:end,3:4)'*scale);
SF2 = csvread('clust_S_F002.csv');
xsf2_ = round(SF2(1:end,1:2)'*scale);
ysf2_ = round(SF2(1:end,3:4)'*scale);
SF1 = csvread('clust_S_F001.csv');
xsf1_ = round(SF1(1:end,1:2)'*scale);
ysf1_ = round(SF1(1:end,3:4)'*scale);

% G videos
KTG5 = csvread('clust_KT_G005.csv');
xktg5_ = round(KTG5(1:end,1:2)'*scale);
yktg5_ = round(KTG5(1:end,3:4)'*scale);
KTG4 = csvread('clust_KT_G004.csv');
xktg4_ = round(KTG4(1:end,1:2)'*scale);
yktg4_ = round(KTG4(1:end,3:4)'*scale);
KTG3 = csvread('clust_KT_G003.csv');
xktg3_ = round(KTG3(1:end,1:2)'*scale);
yktg3_ = round(KTG3(1:end,3:4)'*scale);
KTG2 = csvread('clust_KT_G002.csv');
xktg2_ = round(KTG2(1:end,1:2)'*scale);
yktg2_ = round(KTG2(1:end,3:4)'*scale);
KTG1 = csvread('clust_KT_G001.csv');
xktg1_ = round(KTG1(1:end,1:2)'*scale);
yktg1_ = round(KTG1(1:end,3:4)'*scale);

% no NP G videos

SG5 = csvread('clust_S_G005.csv');
xsg5_ = round(SG5(1:end,1:2)'*scale);
ysg5_ = round(SG5(1:end,3:4)'*scale);
SG4 = csvread('clust_S_G004.csv');
xsg4_ = round(SG4(1:end,1:2)'*scale);
ysg4_ = round(SG4(1:end,3:4)'*scale);
SG3 = csvread('clust_S_G003.csv');
xsg3_ = round(SG3(1:end,1:2)'*scale);
ysg3_ = round(SG3(1:end,3:4)'*scale);
SG2 = csvread('clust_S_G002.csv');
xsg2_ = round(SG2(1:end,1:2)'*scale);
ysg2_ = round(SG2(1:end,3:4)'*scale);
SG1 = csvread('clust_S_G001.csv');
xsg1_ = round(SG1(1:end,1:2)'*scale);
ysg1_ = round(SG1(1:end,3:4)'*scale);

% H videos
KTH5 = csvread('clust_KT_H005.csv');
xkth5_ = round(KTH5(1:end,1:2)'*scale);
ykth5_ = round(KTH5(1:end,3:4)'*scale);
KTH4 = csvread('clust_KT_H004.csv');
xkth4_ = round(KTH4(1:end,1:2)'*scale);
ykth4_ = round(KTH4(1:end,3:4)'*scale);
KTH3 = csvread('clust_KT_H003.csv');
xkth3_ = round(KTH3(1:end,1:2)'*scale);
ykth3_ = round(KTH3(1:end,3:4)'*scale);
% no 1 or 2

NPH5 = csvread('clust_NP_H005.csv');
xnph5_ = round(NPH5(1:end,1:2)'*scale);
ynph5_ = round(NPH5(1:end,3:4)'*scale);
NPH4 = csvread('clust_NP_H004.csv');
xnph4_ = round(NPH4(1:end,1:2)'*scale);
ynph4_ = round(NPH4(1:end,3:4)'*scale);
% no 3
NPH2 = csvread('clust_NP_H002.csv');
xnph2_ = round(NPH2(1:end,1:2)'*scale);
ynph2_ = round(NPH2(1:end,3:4)'*scale);
% no 1

SH5 = csvread('clust_S_H005.csv');
xsh5_ = round(SH5(1:end,1:2)'*scale);
ysh5_ = round(SH5(1:end,3:4)'*scale);
SH4 = csvread('clust_S_H004.csv');
xsh4_ = round(SH4(1:end,1:2)'*scale);
ysh4_ = round(SH4(1:end,3:4)'*scale);
SH3 = csvread('clust_S_H003.csv');
xsh3_ = round(SH3(1:end,1:2)'*scale);
ysh3_ = round(SH3(1:end,3:4)'*scale);
% no 2
SH1 = csvread('clust_S_H001.csv');
xsh1_ = round(SH1(1:end,1:2)'*scale);
ysh1_ = round(SH1(1:end,3:4)'*scale);

% I videos
KTI5 = csvread('clust_KT_I005.csv');
xkti5_ = round(KTI5(1:end,1:2)'*scale);
ykti5_ = round(KTI5(1:end,3:4)'*scale);
% no 4
KTI3 = csvread('clust_KT_I003.csv');
xkti3_ = round(KTI3(1:end,1:2)'*scale);
ykti3_ = round(KTI3(1:end,3:4)'*scale);
KTI2 = csvread('clust_KT_I002.csv');
xkti2_ = round(KTI2(1:end,1:2)'*scale);
ykti2_ = round(KTI2(1:end,3:4)'*scale);
KTI1 = csvread('clust_KT_I001.csv');
xkti1_ = round(KTI1(1:end,1:2)'*scale);
ykti1_ = round(KTI1(1:end,3:4)'*scale);

NPI5 = csvread('clust_NP_I005.csv');
xnpi5_ = round(NPI5(1:end,1:2)'*scale);
ynpi5_ = round(NPI5(1:end,3:4)'*scale);
NPI4 = csvread('clust_NP_I004.csv');
xnpi4_ = round(NPI4(1:end,1:2)'*scale);
ynpi4_ = round(NPI4(1:end,3:4)'*scale);
NPI3 = csvread('clust_NP_I003.csv');
xnpi3_ = round(NPI3(1:end,1:2)'*scale);
ynpi3_ = round(NPI3(1:end,3:4)'*scale);
NPI2 = csvread('clust_NP_I002.csv');
xnpi2_ = round(NPI2(1:end,1:2)'*scale);
ynpi2_ = round(NPI2(1:end,3:4)'*scale);
% no 1

SI5 = csvread('clust_S_I005.csv');
xsi5_ = round(SI5(1:end,1:2)'*scale);
ysi5_ = round(SI5(1:end,3:4)'*scale);
SI4 = csvread('clust_S_I004.csv');
xsi4_ = round(SI4(1:end,1:2)'*scale);
ysi4_ = round(SI4(1:end,3:4)'*scale);
SI3 = csvread('clust_S_I003.csv');
xsi3_ = round(SI3(1:end,1:2)'*scale);
ysi3_ = round(SI3(1:end,3:4)'*scale);
SI2 = csvread('clust_S_I002.csv');
xsi2_ = round(SI2(1:end,1:2)'*scale);
ysi2_ = round(SI2(1:end,3:4)'*scale);
SI1 = csvread('clust_S_I001.csv');
xsi1_ = round(SI1(1:end,1:2)'*scale);
ysi1_ = round(SI1(1:end,3:4)'*scale);
