...
% plot(x_(1,:),y_(1,:),'k'); % looks like the better ee to track
% hold on
% plot(x_(2,:),y_(2,:),'r');

%% independent hmm for each dimension 
%seq = [xktd3_(1,:),xsd5_(1,:),xktd4_(1,:),xsd4_(1,:),xktd3_(1,:),xsd4_(1,:),xktd4_(1,:),xsd5_(1,:); 
%       yktd3_(1,:),ysd5_(1,:),yktd4_(1,:),ysd4_(1,:),yktd3_(1,:),ysd4_(1,:),yktd4_(1,:),ysd5_(1,:)]; % data for first end effector
